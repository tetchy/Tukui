...
local function CreateButton(name, parent, template, width, height, point, relativeto, point2, xOfs, yOfs, text, texture)
	...
	if text then
		...
		t:SetFont(C.media.font,C["datatext"].fontsize,"OUTLINE")
		t:SetPoint("CENTER")
...
CreateButton("ShowButton", RaidUtilityPanel, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", RaidUtilityPanel:GetWidth() / 2.5, T.Scale(18), "TOP", UIParent, "TOP", -300, 2, "Raid Utility", nil)
