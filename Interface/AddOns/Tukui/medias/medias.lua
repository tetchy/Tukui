...
C["media"] = {
	...
	["uffontp"] = [[Interface\AddOns\Tukui\medias\fonts\uf_fontp.ttf]], -- pixel font of unitframes
	...
	--["bordercolor"] = { .14,.14,.14 }, -- border color of tukui panels
	["bordercolor"] = { .23,.23,.23 }, -- border color of tukui panels
	["altbordercolor"] = { .14,.14,.14 }, -- alternative border color, mainly for unitframes text panels.
