...
CreateMarkerButton("YellowFlare", tukuilocal.core_raidutil_yellow, "TOPLEFT", RedFlare, "BOTTOMLEFT")
YellowFlare:SetAttribute("macrotext", [[
/click CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton
/click DropDownList1Button5
]])
CreateMarkerButton("ClearFlare", tukuilocal.core_raidutil_clear, "TOPLEFT", YellowFlare, "BOTTOMLEFT")
